...
// Етикети на новите раздели (виж DISCOVERY_LABELS по-долу) се добавят към batch превода.
// Всички видими низове от разделите „API & Agents" и „SEO & Discovery".
// НЕ се превеждат: имена на релации, HTTP методи, медийни типове, пътища,
// operationId, OAuth идентификатори и имена на схеми.
const DISCOVERY_LABELS = [
  "API & Agents", "SEO & Discovery",
  "Публични API-та, машинно четимо откриване, метаданни за автентикация и съвместимост с AI агенти.",
  "Видимост в търсачките, структурирани метаданни, индексируемост и диагностика на обхождащите.",
  // Статуси
  "Успешна", "Изисква внимание", "Неуспешна", "Неприложима", "Чака", "Няма валидация",
  "Критичен", "Висок", "Предупреждение", "Информация", "да", "не", "няма", "Проверено",
  // Обобщение
  "Готовност за агенти", "Обобщение", "от", "проверки минаха", "изискват внимание", "неуспешни",
  "неприложими", "Всички проверки минаха", "Още няма валидация",
  "Пуснете одит, за да видите реалното състояние. Дотогава не се показват статуси.",
  "Публично API", "OpenAPI", "API каталог", "Markdown за агенти", "Link заглавки",
  "OAuth/OIDC откриване", "Страници за агенти", "Последна пълна валидация", "Собствен издател",
  "Няма", "версия", "публични маршрута", "записа в linkset", "страници с markdown", "открити релации",
  "Пусни първия одит",
  "Пуснете първия одит, за да се провери какво реално връща продукцията. Дотогава не се показват статуси.",
  // Действия
  "Пълен одит на API и агенти", "Пълен SEO одит", "Изпълнява се…", "Изтегли отчета", "Обнови",
  "Валидирай", "Валидирай отново", "Валидирай каталога", "Валидирай всички страници",
  "Валидирай структурираните данни", "Валидирай спрямо реалните маршрути", "Отвори", "Отвори документа",
  "Отвори каталога", "Документация", "Статус", "Тествай", "Отказ", "Стартирай одита", "Затвори",
  "Спри безопасно", "Действия",
  // Потвърждения
  "Пълен одит на API и агенти", "Одитът изпраща десетки заявки към продукционния сайт и записва резултата. Не се променят публични данни. Продължавате ли?",
  "Одитът чете sitemap-а, robots.txt и десетки публични страници от продукцията и записва резултата. Не се променя съдържание. Продължавате ли?",
  // Прогрес
  "Одитът се изпълнява", "Текуща група", "Текущ ресурс", "Изпълнени", "Чакащи", "Стартиран",
  "Одитът продължава на сървъра. Може да презаредите страницата — прогресът не се губи.",
  // Таблици
  "Проверка", "Стандарт", "Ресурс", "Отговор", "Време", "Детайли", "Дата", "Задействане", "Версия",
  "Успешни", "Предупреждения", "Неуспешни", "Времетраене", "Ръчно", "По график", "Спрян",
  "Тежест", "Описание", "Засичания", "Последно", "Няма проверки", "Тази група още не е валидирана.",
  "Няма записани одити", "Историята се попълва след първия завършил одит.",
  "Няма отворени сигнали", "Валидациите не са открили нерешени проблеми.",
  "Всички проверки от последния одит", "Отворени сигнали", "История на валидациите",
  "Данните не могат да бъдат заредени", "Грешка",
  // Публично API
  "Базов адрес", "Версия на приложението", "Документирани публични маршрути", "Публични маршрути",
  "Защитени маршрути", "Вътрешни (извън документацията)", "Здравен статус",
  "Последна успешна валидация", "Средно време за отговор", "Грешки при последната валидация",
  "Ограничаване на честотата", "Няма конфигурирано на ниво приложение", "Кеширане",
  "Публичните отговори: 60–3600 s; личните: no-store", "База данни", "достъпна", "недостъпна",
  "Публични операции", "Метод", "Път", "Достъп", "Тип", "Кеш", "публичен",
  "Търсене по път, operationId или група…", "Търсене", "Филтър", "Всички", "Само публични",
  "Само защитени", "Документирани", "Недокументирани", "Кешируеми", "Само грешки",
  "Всички методи", "Всички групи", "Група", "Няма маршрути по този филтър", "няма безопасна проба",
  "Административните и вътрешните маршрути умишлено не се показват тук и не се публикуват в OpenAPI или API каталога.",
  "Предишна", "Следваща",
  // Preview
  "Отговор от продукцията", "Адрес", "Заглавки на заявката", "Код", "Тип съдържание", "Размер",
  "Очакван тип", "Тяло (съкратено и изчистено)",
  "Бисквитки, токени и лични данни се премахват на сървъра, преди отговорът да стигне до браузъра.",
  // OpenAPI
  "OpenAPI спецификация", "Версия на OpenAPI", "Версия на API", "Операции", "Схеми", "Групи (tags)",
  "Сървъри", "Последна валидация", "Сравнение с реалния рутер", "Документирани операции",
  "Публични, но недокументирани", "Липсват в описанието", "Описани, но липсват в рутера",
  "Повтарящи се operationId", "Изтекли частни маршрути",
  "Пуснете одит, за да се провери документът срещу продукцията.",
  // Каталог
  "API каталог (RFC 9727)", "Записи в linkset", "Анкери", "GET проверка", "HEAD проверка",
  "Рекламирани частни API", "Последна успешна проверка", "Пуснете одит, за да се провери каталогът.",
  "Релация", "Цел", "Обявен тип", "Реален тип", "Валидна",
  // Link
  "Link заглавки за откриване (RFC 8288)", "GET начална страница (HTML)", "HEAD начална страница",
  "Markdown отговор", "Дублирани стойности", "Липсващи релации",
  "Пуснете одит, за да се прочетат заглавките от продукцията.",
  // Markdown
  "Реализация", "Cloudflare Worker (генерира се от D1)", "Настройка в Cloudflare",
  "Не може да се прочете с текущия API токен — проверете в таблото на Cloudflare",
  "Продукционен хост", "Поддържани страници", "Неуспешни страници", "Страница",
  "Смислено съдържание", "Токени", "Намаление", "заглавия", "думи", "празна SPA обвивка",
  "Пуснете одит, за да се тества всяка страница срещу продукцията.",
  "Намалението на токени е оценка спрямо размера на HTML отговора, освен ако Cloudflare не върне x-original-tokens.",
  // OAuth
  "OAuth и OpenID Connect откриване", "Вход с Google (OAuth клиент)", "Издава собствени токени за API",
  "OAuth Authorization Server", "OpenID Provider", "Няма собствени discovery метаданни",
  "Приложението е само клиент на Google за вход. Не се публикува фиктивен discovery документ.",
  "Издател (issuer)", "Съвпада с продукционния хост", "НЕ — метаданните заблуждават",
  "Discovery адрес", "OpenID конфигурация", "Метаданни на ресурса", "Публични ключове", "Ресурс",
  "Динамична регистрация", "не се поддържа", "не се обявява", "PKCE",
  "Тук никога не се показват клиентски тайни, частни подписващи ключове, токени или сесийни данни.",
  // Ресурси
  "Ресурси за откриване от агенти", "Експериментален ресурс",
  // SEO
  "Адреси в sitemap", "Адреси на процедури", "Индексируеми публични страници",
  "Страници с валиден каноничен адрес", "Страници със структурирани данни",
  "Страници с пълни метаданни", "Критични проблеми", "Последен SEO одит",
  "Динамичен XML sitemap", "Начин на генериране", "Динамично от Worker-а", "Източник на данни",
  "Cloudflare D1 (процедури + програмни страници)", "Общо адреси", "Уникални адреси",
  "Програмни страници", "Статични адреси", "С lastmod", "Най-нов lastmod", "Дублирани адреси",
  "Невалидни адреси", "Адреси към друг хост", "Частни маршрути", "Адреси с query", "XSL изглед",
  "Пуснете одит, за да се прочете sitemap-ът от продукцията.", "Частни маршрути в sitemap",
  "Липсващи в sitemap",
  // robots
  "Robots и политика за обхождане", "Групи правила", "Sitemap препратки", "Неразпознати директиви",
  "не са декларирани", "Обхождащ агент", "Вид", "Собствена група", "наследява *",
  "Публично съдържание", "AI агент", "Социален", "Търсачка",
  "Пуснете одит, за да се прочете robots.txt от продукцията.",
  "Политиката за AI агенти се променя само изрично — тук не се блокира и не се разрешава автоматично нищо.",
  // Метаданни
  "Одит на метаданните", "Само предупреждения", "Неиндексируеми", "Вид страница", "Език",
  "Заглавие", "Описание", "Каноничен", "Структурирани данни", "зн.", "липсва",
  "Пуснете одит, за да се прочетат метаданните от продукцията.",
  "Начална", "Списък процедури", "Процедура", "Програми", "За платформата", "Източници",
  "Календар", "Промени", "Правна", "API документация",
  // Процедури
  "SEO на процедурите", "Общо публични процедури", "Процедури в sitemap", "Липсващи в sitemap",
  "Без официален източник", "Без програма", "Дублирани идентификатори", "Дублирани заглавия",
  "Изтекли, но още отворени", "С документи", "Обхванати държави", "Идентификатор", "Краен срок",
  "Документи", "Официален източник", "Обновена", "изтекъл срок", "Изтекли, но отворени",
  "Данните за процедурите се четат от базата.",
  "Съдържанието на официалните източници не може да се променя от този екран — то идва само от автоматичната синхронизация.",
  // Structured data / social
  "Тип схема", "Блокове", "Проблеми",
  "Пуснете одит, за да се прочетат JSON-LD блоковете от продукцията.",
  "Използват се само схеми, които отговарят на реалното съдържание — не се добавят типове само заради SEO.",
  "Социални визитки", "Приблизителен изглед", "Няма заглавие", "Няма описание", "Липсващи полета",
  "Пуснете одит, за да се прочетат og: и twitter: таговете от продукцията.",
  "Прегледите са приблизителни — реалният изглед се определя от съответната платформа.",
  // i18n
  "Многоезично SEO", "Езици на интерфейса", "Индексируеми езици",
  "hreflang връзки на началната страница", "Невалидни езикови кодове",
  "Езикови цели към друг хост", "Реципрочност", "Езикови страници /bg /en /de", "Държава ≠ език",
  "Спазено — изборът на държава не сменя езика", "Съответства",
  "Пуснете одит, за да се проверят езиковите алтернативи.",
  // Производителност
  "Техническо SEO и производителност", "Компресия", "не се обявява",
  "LCP, CLS, INP (полеви данни)", "Няма налични — не е свързан източник на полеви данни",
  "Лабораторни измервания", "Няма налични", "Измерено от одита",
  "TTFB и размер на отговора — реални стойности", "Още няма измервания",
  "Пуснете одит, за да се измерят реалните отговори.",
  "Core Web Vitals не се показват, защото няма свързан източник на полеви данни. Стойности не се измислят.",
  // AI агенти
  "Оптимизация за AI агенти и обхождащи",
  "Този раздел е за ВЪНШНИ агенти и обхождащи, които четат публичната платформа. Вътрешните AI модели на системата се управляват в раздел „AI модели“.",
];
...
// Подзаглавие според активния раздел.
const TAB_SUBTITLE = {
  ...
  return (
    <UiTrContext.Provider value={tl}>
      ...
      <main id="main" className="container page admin">
        <div className="page-head"><h1>{tl("Настройки · Администрация")}</h1><p>{tl(TAB_SUBTITLE[tab] || "Системни настройки, потребители, журнал на грешките и сигнали.")}</p></div>
