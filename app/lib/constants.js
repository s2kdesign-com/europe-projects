...
// 7/30/90 = „тази седмица / този месец / това тримесечие". Проследяването е
// започнало скоро, затова по-малкият прозорец (7 дни) реално стеснява потока.
...
export const PERIOD_DAYS = { "7": 7, "30": 30, "90": 90 };
