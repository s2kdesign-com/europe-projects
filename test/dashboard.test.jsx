...
describe("Детайли drawer — lazy документи и клавиатура", () => {
  it("отваря се, зарежда документи и се затваря с Escape", async () => {
    ...
    // Секция „Документи“ е винаги в DOM (вертикален скрол, без табове) —
    // мързеливо зареденото заглавие се появява след fetch-а (среща се и в
    // бутона на документа, и в „Официални източници").
    await waitFor(() =>
      expect(within(dialog).getAllByText("Условия за кандидатстване").length).toBeGreaterThan(0)
    );
